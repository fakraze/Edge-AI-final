...
def main():
    ...
    #     device_map=device,
    # )
    # model = PeftModel.from_pretrained(base_model, "qlora-wikitext2")
    # print(f"Loaded model: qlora-wikitext2")
        
    adapter_repo = "fakraze/qlora-wikitext2-llama3-3b"
    base_model = AutoModelForCausalLM.from_pretrained(
        "meta-llama/Llama-3.2-3B-Instruct",
        torch_dtype=torch.float16,
        device_map=device,
    ...
    print(f"Loaded model: {adapter_repo}")
    ...
    # tokenizer = AutoTokenizer.from_pretrained("qlora-wikitext2")    
